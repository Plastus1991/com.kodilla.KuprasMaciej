...
public class TrelloClientTest {
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/cards?key=test&token=test&name=Test1&desc=Test1&pos=top&idList=test_id");
    ...
    public void shouldReturnEmptyList() throws URISyntaxException {
        ...
        List<TrelloBoardDto> board = trelloClient.getTrelloBoards();
